...
export const metadata = pageMetadata({
  ...
  description:
    "SwissPro Allround Service GmbH bietet Gebäudereinigung, Umzug, Räumung, Renovation und Gartenpflege in Winterthur, Zürich und der Ostschweiz.",
      ...
      <section className="px-5 pt-8 sm:px-6 lg:px-8">
        <div className="mx-auto grid w-full max-w-7xl gap-8 rounded-[2.4rem] border border-white/45 bg-[linear-gradient(160deg,rgba(14,34,81,0.96),rgba(26,79,189,0.94))] px-6 py-10 text-white shadow-[0_30px_80px_rgba(12,41,98,0.2)] sm:px-8 lg:grid-cols-[1.1fr_0.9fr] lg:px-12 lg:py-14">
          ...
          <PlaceholderMedia
            ...
            hint="Reinigung, Umzug, Räumung, Renovation und Gartenpflege für private und gewerbliche Objekte."
        ...
        <div className="mx-auto w-full max-w-7xl">
          ...
          <div className="mt-10 grid gap-5 lg:grid-cols-2">
            {services.map((service) => (
              <article
                key={service.slug}
                className="rounded-[2rem] border border-[var(--border)] bg-[var(--surface)] p-6 shadow-[0_20px_55px_rgba(12,41,98,0.08)]"
              >
