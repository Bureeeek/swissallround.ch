...
function ReviewCard({
  ...
  return (
    <article className="flex min-h-[15.5rem] w-[19.5rem] flex-col justify-between rounded-2xl border border-white/10 bg-white/[0.08] p-6 text-white shadow-[0_20px_55px_rgba(4,10,24,0.18)] backdrop-blur-xl sm:w-[21.5rem]">
      <div>
        <Stars />
  ...
  return (
    <section className="px-5 py-16 sm:px-6 lg:px-8">
      <Reveal className="mx-auto w-full max-w-[92rem]">
        <div className="overflow-hidden rounded-[2.5rem] border border-[rgba(147,188,255,0.16)] bg-[linear-gradient(150deg,rgba(8,17,38,0.98),rgba(13,37,88,0.94))] shadow-[0_28px_80px_rgba(8,17,38,0.18)]">
          <div className="grid gap-8 px-6 py-8 sm:px-8 lg:grid-cols-[0.88fr_1.12fr] lg:px-10 lg:py-10">
            ...
            <div className="flex rounded-[2rem] border border-white/10 bg-white/[0.06] p-6 text-white">
              <div>
          ...
          <div className="relative border-t border-white/8 py-6">
            <div className="pointer-events-none absolute inset-y-0 left-0 z-10 w-16 bg-[linear-gradient(90deg,rgba(8,17,38,0.98),rgba(8,17,38,0))] sm:w-24" />
            <div className="pointer-events-none absolute inset-y-0 right-0 z-10 w-16 bg-[linear-gradient(270deg,rgba(13,37,88,0.94),rgba(13,37,88,0))] sm:w-24" />
